...
solc:
	...
	solc --abi ./contracts/sol/IERC20Metadata.sol > ./contracts/abi/IERC20Metadata.abi
...
abi-gen:
	...
	abigen --abi=./contracts/abi/IERC20Metadata.abi --pkg=contracts --type=IERC20Metadata > ./contracts/IERC20Metadata.go
