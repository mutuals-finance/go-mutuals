...
var RegistryMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"target\",\"type\":\"address\"}],\"name\":\"AddressEmptyCode\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"implementation\",\"type\":\"address\"}],\"name\":\"ERC1967InvalidImplementation\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"ERC1967NonPayable\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"key\",\"type\":\"bytes32\"}],\"name\":\"EnumerableMapNonexistentKey\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"FailedCall\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"InvalidInitialization\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"NotInitializing\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"OwnableInvalidOwner\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"OwnableUnauthorizedAccount\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"UUPSUnauthorizedCallContext\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"slot\",\"type\":\"bytes32\"}],\"name\":\"UUPSUnsupportedProxiableUUID\",\"type\":\"error\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"uint64\",\"name\":\"version\",\"type\":\"uint64\"}],\"name\":\"Initialized\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"implementation\",\"type\":\"address\"}],\"name\":\"Upgraded\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"UPGRADE_INTERFACE_VERSION\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_owner\",\"type\":\"address\"}],\"name\":\"__Registry_init\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"extensionId\",\"type\":\"bytes32\"}],\"name\":\"exists\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"extensionId\",\"type\":\"bytes32\"}],\"name\":\"extensionOf\",\"outputs\":[{\"internalType\":\"contractIExtension\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"proxiableUUID\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"extension\",\"type\":\"address\"},{\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\"}],\"name\":\"register\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"extensionId\",\"type\":\"bytes32\"}],\"name\":\"unregister\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newImplementation\",\"type\":\"address\"},{\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\"}],\"name\":\"upgradeToAndCall\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"}]",
}
...
//
// Solidity: function exists(bytes32 extensionId) view returns(bool)
func (_Registry *RegistryCaller) Exists(opts *bind.CallOpts, extensionId [32]byte) (bool, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "exists", extensionId)
...
//
// Solidity: function exists(bytes32 extensionId) view returns(bool)
func (_Registry *RegistrySession) Exists(extensionId [32]byte) (bool, error) {
	return _Registry.Contract.Exists(&_Registry.CallOpts, extensionId)
}

// Exists is a free data retrieval call binding the contract method 0x38a699a4.
//
// Solidity: function exists(bytes32 extensionId) view returns(bool)
func (_Registry *RegistryCallerSession) Exists(extensionId [32]byte) (bool, error) {
	return _Registry.Contract.Exists(&_Registry.CallOpts, extensionId)
}

// ExtensionOf is a free data retrieval call binding the contract method 0x7264d2bc.
//
// Solidity: function extensionOf(bytes32 extensionId) view returns(address)
func (_Registry *RegistryCaller) ExtensionOf(opts *bind.CallOpts, extensionId [32]byte) (common.Address, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "extensionOf", extensionId)
...
//
// Solidity: function extensionOf(bytes32 extensionId) view returns(address)
func (_Registry *RegistrySession) ExtensionOf(extensionId [32]byte) (common.Address, error) {
	return _Registry.Contract.ExtensionOf(&_Registry.CallOpts, extensionId)
}

// ExtensionOf is a free data retrieval call binding the contract method 0x7264d2bc.
//
// Solidity: function extensionOf(bytes32 extensionId) view returns(address)
func (_Registry *RegistryCallerSession) ExtensionOf(extensionId [32]byte) (common.Address, error) {
	return _Registry.Contract.ExtensionOf(&_Registry.CallOpts, extensionId)
}
...
// RegistryInit is a paid mutator transaction binding the contract method 0x596968e5.
//
// Solidity: function __Registry_init(address _owner) returns()
func (_Registry *RegistryTransactor) RegistryInit(opts *bind.TransactOpts, _owner common.Address) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "__Registry_init", _owner)
}

// RegistryInit is a paid mutator transaction binding the contract method 0x596968e5.
//
// Solidity: function __Registry_init(address _owner) returns()
func (_Registry *RegistrySession) RegistryInit(_owner common.Address) (*types.Transaction, error) {
	return _Registry.Contract.RegistryInit(&_Registry.TransactOpts, _owner)
}

// RegistryInit is a paid mutator transaction binding the contract method 0x596968e5.
//
// Solidity: function __Registry_init(address _owner) returns()
func (_Registry *RegistryTransactorSession) RegistryInit(_owner common.Address) (*types.Transaction, error) {
	return _Registry.Contract.RegistryInit(&_Registry.TransactOpts, _owner)
}

// Register is a paid mutator transaction binding the contract method 0x24b8fbf6.
//
// Solidity: function register(address extension, bytes data) returns()
func (_Registry *RegistryTransactor) Register(opts *bind.TransactOpts, extension common.Address, data []byte) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "register", extension, data)
}

// Register is a paid mutator transaction binding the contract method 0x24b8fbf6.
//
// Solidity: function register(address extension, bytes data) returns()
func (_Registry *RegistrySession) Register(extension common.Address, data []byte) (*types.Transaction, error) {
	return _Registry.Contract.Register(&_Registry.TransactOpts, extension, data)
}

// Register is a paid mutator transaction binding the contract method 0x24b8fbf6.
//
// Solidity: function register(address extension, bytes data) returns()
func (_Registry *RegistryTransactorSession) Register(extension common.Address, data []byte) (*types.Transaction, error) {
	return _Registry.Contract.Register(&_Registry.TransactOpts, extension, data)
}
...
//
// Solidity: function unregister(bytes32 extensionId) returns()
func (_Registry *RegistryTransactor) Unregister(opts *bind.TransactOpts, extensionId [32]byte) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "unregister", extensionId)
}

// Unregister is a paid mutator transaction binding the contract method 0x1a0919dc.
//
// Solidity: function unregister(bytes32 extensionId) returns()
func (_Registry *RegistrySession) Unregister(extensionId [32]byte) (*types.Transaction, error) {
	return _Registry.Contract.Unregister(&_Registry.TransactOpts, extensionId)
}

// Unregister is a paid mutator transaction binding the contract method 0x1a0919dc.
//
// Solidity: function unregister(bytes32 extensionId) returns()
func (_Registry *RegistryTransactorSession) Unregister(extensionId [32]byte) (*types.Transaction, error) {
	return _Registry.Contract.Unregister(&_Registry.TransactOpts, extensionId)
}
