...
func (l *CollectionLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *CollectionLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewCollectionLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([]coredb.Collection, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "CollectionLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "CollectionLoaderByID")
		}
