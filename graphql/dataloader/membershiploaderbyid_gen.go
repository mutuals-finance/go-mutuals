...
func (l *MembershipLoaderById) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *MembershipLoaderById) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewMembershipLoaderById(
	...
	loader.fetch = func(keys []persist.DBID) ([]coredb.Membership, []error) {
		ctx := loader.ctx

		// Allow the preFetchHook to modify and return a new context
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "MembershipLoaderById")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "MembershipLoaderById")
		}
