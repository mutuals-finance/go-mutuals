...
func (l *UsersLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *UsersLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewUsersLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([][]coredb.User, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "UsersLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "UsersLoaderByID")
		}
