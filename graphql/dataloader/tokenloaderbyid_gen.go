...
func (l *TokenLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *TokenLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewTokenLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([]coredb.Token, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "TokenLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "TokenLoaderByID")
		}
