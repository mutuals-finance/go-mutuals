...
func (l *WalletsLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *WalletsLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewWalletsLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([][]coredb.Wallet, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "WalletsLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "WalletsLoaderByID")
		}
